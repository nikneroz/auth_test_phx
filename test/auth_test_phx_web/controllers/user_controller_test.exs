defmodule AuthTestPhxWeb.UserControllerTest do
  use AuthTestPhxWeb.ConnCase

  alias AuthTestPhx.Accounts

  @create_attrs %{email: "some email", encrypted_password: "some encrypted_password", remember_created_at: ~T[14:00:00], reset_password_sent_at: ~T[14:00:00], reset_password_token: "some reset_password_token"}
